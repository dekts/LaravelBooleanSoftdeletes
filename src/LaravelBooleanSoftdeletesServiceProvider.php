...
namespace dekts\LaravelBooleanSoftdeletes;
...
class LaravelBooleanSoftdeletesServiceProvider extends ServiceProvider
{
    ...
    {
        // $this->loadTranslationsFrom(__DIR__.'/../resources/lang', 'dekts');
        // $this->loadViewsFrom(__DIR__.'/../resources/views', 'dekts');
    ...
    protected function bootForConsole()
    {
        ...
        /*$this->publishes([
            __DIR__.'/../resources/views' => base_path('resources/views/vendor/dekts'),
        ], 'laravelbooleansoftdeletes.views');*/

        // Publishing assets.
        /*$this->publishes([
            __DIR__.'/../resources/assets' => public_path('vendor/dekts'),
        ], 'laravelbooleansoftdeletes.views');*/

        // Publishing the translation files.
        /*$this->publishes([
            __DIR__.'/../resources/lang' => resource_path('lang/vendor/dekts'),
        ], 'laravelbooleansoftdeletes.views');*/
